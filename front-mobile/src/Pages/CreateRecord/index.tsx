...
import PlatformCard from './PlaftormCard';
...
const CreateRecord = () => {
    ...
    const [filteredGame, setFilteredGames] = useState<Game[]>([]);

    const handdleChangePlatform = (selectedPlatform : GamePlatform) => {
            ...
            <View style={styles.container}>
                ...
                <View style={styles.platformContainer}>
                    <PlatformCard 
                        platform="PC"
                        icon="laptop"
                        onChange={handdleChangePlatform}
                ...
                <View style={styles.footer}>
                    <RectButton style={styles.button} onPress={handdleSubmit}>
